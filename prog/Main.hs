...
printTopicHelp "lc-lang" = do
    putStrLn . unlines $
      ...
      , "implementations that define a string translation. These pairs are"
      , "represented with 'key: value' syntax. Example english locale file:"
      , ""
      , "locale en_US:"
      , ""
      ...
      , ""
      , "\t# simple lambda functions are available, ${} blocks are evaluated"
      , "\t# use @var to reference an argument, $.path to access other elements"
      , "\t#   or builtin functions"
